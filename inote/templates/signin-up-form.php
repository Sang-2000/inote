        ...
        <div class="col-md-5">
            ...
            <form method="POST" onsubmit="return false;" id="formSignin">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Ví dụ: hoahongxanh" id="user_signin">
                </div>
                <div class="form-group">
                    <label for="pass_signin">Mật khẩu</label>
                    <input type="password" class="form-control" placeholder="Ví dụ: 123456" id="pass_signin">
                </div>
                <button type="submit" class="btn btn-primary" id="submit_signin">Đăng nhập</button>
                <br><br>
